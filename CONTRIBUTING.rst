...
.. _easy-as-pypi-config: https://github.com/tallybark/easy-as-pypi-config

.. |user-docs| replace:: user documentation
.. _user-docs: https://github.com/tallybark/easy-as-pypi-config/tree/release/docs
...
Report bugs at https://github.com/tallybark/easy-as-pypi-config/issues.
...
the `README
<https://github.com/tallybark/easy-as-pypi-config/blob/release/README.rst>`__,
and the inline docstrings that generate the `API documentation
<https://easy-as-pypi-config.readthedocs.io/en/latest/modules.html>`__
...
https://github.com/tallybark/easy-as-pypi-config/issues.
...
Ready to contribute? Here's how to set up |easy-as-pypi-config|_
for local development.

1. Fork the |easy-as-pypi-config|_ repo on GitHub.

   * Visit `<https://github.com/tallybark/easy-as-pypi-config>`__
     and click *Fork*.
...
2. Clone your fork locally.
   ...
   and run the command::
    ...
    $ git clone git@github.com:<your_login>/easy-as-pypi-config.git

3. Install |easy-as-pypi-config|_ into a Python virtual instance,
   or |virtualenv|_.
   ...
   Next, set up a virtual environment for local development::
    ...
    $ mkvirtualenv -a $(pwd) easy-as-pypi-config
    (easy-as-pypi-config) $

   *Note:* We use the ``-a`` option so that ``cdproject`` changes directories
   to the ``easy-as-pypi-config/`` directory when we're in the virtual
   environment.

   Next, set up your fork for local development::

    (easy-as-pypi-config) $ cdproject
...
4. Before starting work on a new feature or bug fix, make sure your
   ``develop`` branch is up to date with the official branch::
    ...
    (easy-as-pypi-config) $ cdproject
    (easy-as-pypi-config) $ git remote add upstream git@github.com:tallybark/easy-as-pypi-config.git
    (easy-as-pypi-config) $ git fetch upstream
    (easy-as-pypi-config) $ git checkout develop
    (easy-as-pypi-config) $ git rebase upstream/develop
    (easy-as-pypi-config) $ git push origin HEAD
...
10. Finally,
    ...
    <https://github.com/tallybark/easy-as-pypi-config/pulls>`_
...
1. You can lint the code easily with one command.
   ...
   .. code-block:: Bash
      ...
      $ flake8 setup.py easy_as_pypi_config/ tests/
...
** 🐬 Happy 🐠 easy-as-pypi-config 🦖 Hacking!! 🐡 **
